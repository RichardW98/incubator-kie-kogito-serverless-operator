...
const (
	...
	JobServiceEventsURL                   = "mp.messaging.outgoing.kogito-jobs-events.url"
	JobServiceEventsConnector             = "mp.messaging.outgoing.kogito-jobs-events.connector"
	JobServiceEventsMethod                = "mp.messaging.outgoing.kogito-jobs-events.method"
